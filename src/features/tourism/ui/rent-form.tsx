import { VStack, Input, Button, Textarea, InputGroup, InputLeftElement, InputRightAddon } from "@chakra-ui/react";
...
export default function RentForm({ tourism }: { tourism: IToursimPlacesCollection }) {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            <VStack spacing={4}>
                ...
                <Button type="submit" w="100%" loadingText="Claimng..." isLoading={isSubmitingLoading} disabled={isSubmitingLoading}>
                    Claim {tourism.title}
                </Button>
            </VStack>
        </form>
